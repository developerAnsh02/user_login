                                            ...
                                            <div class="modal fade bd-example-modal-xl" id="editModalw" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    ...
                                                    <div class="modal-content" style="width: 80%;">
                                                        ...
                                                        <form class="floating-labels m-t-40" role="form" method="post" action="<?php echo base_url(); ?>index.php/leads/writefilec/" enctype="multipart/form-data">
                                                        <input type="hidden" class="m_lead_id" name="order_id" value="<?= $id ?>">
                                                        <input type="hidden" class="" name="url" value="<?= base_url() ?>Orders/orderchat/<?= $order_id ?>">
