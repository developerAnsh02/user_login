                                                                                        ...
                                                                                        <?php if ($obj['projectstatus'] == 'In Progress') { ?>
                                                                                            <select name="writer_name" class="form-control" required>
                                                                                                <option value=" " <?php if (@$obj['writer_name'] == ' ') {
                                                                                                 ...
                                                                                                 <option value="team 1" <?php if (@$obj['writer_name'] == 'team 1') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 1</option>
                                                                                                <option value="team 2" <?php if (@$obj['writer_name'] == 'team 2') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 3</option>
                                                                                                  <option value="team 3" <?php if (@$obj['writer_name'] == 'team 3') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 3</option>
                                                                                
                                                                                                    <option value="team 4" <?php if (@$obj['writer_name'] == 'team 4') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 4</option>
                                                                                                   <option value="team 5" <?php if (@$obj['writer_name'] == 'team 5') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 5</option>
                                                                                                 <option value="team 6" <?php if (@$obj['writer_name'] == 'team 6') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 6</option>
                                                                                                  <option value="team 7" <?php if (@$obj['writer_name'] == 'team 7') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 7</option>
                                                                                                 <option value="team 8" <?php if (@$obj['writer_name'] == 'team 8') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team 8</option>
                                                                                                 <option value="team 9" <?php if (@$obj['writer_name'] == 'team 9') {
                                                                                                                    echo "selected";
                                                                                                                } ?>>team  9</option>
                                                                                                 <option value="team 10" <?php if (@$obj['writer_name'] == 'team 10') {
                                                                                                                } ?>>team 10</option>
                                                                                                  <option value="team 11" <?php if (@$obj['writer_name'] == 'team 11') {
                                                                                                 } ?>>team 11</option>
                                                                                            </select>
                                                                                            <span class="bar"></span>
