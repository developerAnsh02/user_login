                                                                        ...
                                                                        <div class="col-lg-4">
                                                                            ...
                                                                            <?php if ($role_id != 1) { ?>
                                                                                <?php if ($projectstatus != 'Cancelled') { ?>
                                                                                    ...
                                                                                    <div class="col-lg-4">
                                                                                        <div class="form-group has-warning m-b-40">
                                                                                            <select class="change form-control pages" name="projectstatus" required>
                                                                            ...
                                                                            <?php } else { ?>
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    <div class="form-group has-warning m-b-40">
                                                                                    <select class="change form-control pages projectstatus<?php echo $obj['order_id']; ?>" name="projectstatus" onClick="getDropDown<?php echo $obj['order_id']; ?>()">
                                                                                        <option value="Pending" <?php if ($projectstatus == 'Pending') {
                                                                                                                        echo "selected";
                                                                                                                    } ?>>Pending</option>
