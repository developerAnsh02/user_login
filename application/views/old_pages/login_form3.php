...
<body>
   ...
   <div class="header-image">
     <div class="bs-example">
         <nav class="navbar navbar-expand-md navbar-dark " style="margin:0px;padding:0px;">
            ...
            <a class="navbar-brand" href="tel:+447520626128" style="font-size:1rem;font-size: 18px;"> <i class="fa fa-phone"></i> +44 7520626128</a>
   ...
   <a href="https://www.assignnmentinneed.com" class="navbar-brand"><img src="<?php echo base_url();?>assets/download.png" class="mobile-image"></a>
