       ...
       <div class="card-header no-print">
          ...
          <div class="pull-right no-print">
            ...
            <button class="btn btn-primary"><i class="fa fa-edit"></i> 
              <a href="<?php echo base_url(); ?>index.php/Invoice/previewEdit/<?php echo $invoice_data[0]['id']; ?>" style="color:#fff;">&nbsp;Edit Form </a></button>
              <!-- </form> -->
          </div> 
          ...
          <div class="pull-right">
              <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Invoice/form_submit/<?php echo $invoice_data[0]['id']; ?>" >
                <button class="btn btn-info"><i class="fa fa-check"></i>&nbsp;Final Submit </button>
              </form>
          </div>
