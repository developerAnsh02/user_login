  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      ...
      <div class="pull-right error_msg">
        <a href="<?php echo base_url(); ?>index.php/Orders/payments/<?php echo $id; ?>" class="btn btn-xs btn-primary "> Add Payment <i style="color:#fff;" class="fa fa-money"> </i>
        </a>
        ...
        <div class="form-group">
          <div class="row col-md-12">
            <div class="col-md-4 col-sm-4">
              ...
              <input type="hidden" name="actualorder" class="actualorder" value="<?php echo $actual_amount; ?>">
            ...
            <div class="col-md-4 col-sm-4">
              ...
              <?php if ($role_id != '2') {  ?>
                <input type="text" name="order_total" class="order_total" value="<?php echo $amount; ?>">
              <?php } else { ?>
                ...
                <!-- <div class="col-md-4 col-sm-4">
						<label> Referral Amount Updation :</label>
						 <select class="form-control" name="referal">
							  ...
							  <option value="No"  <?php if ($referal == 'No') {
                                      echo "selected";
                                    } ?> >No</option>
							  <option value="Yes" <?php if ($referal == 'Yes') {
                                      echo "selected";
                                    } ?>>Yes</option>
						 </select>
					 </div> -->
            ...
            <div class="col-md-4 col-sm-4">
              <?php if (!empty($writer_deadline)) {
                if (@$writer_deadline != '1970-01-01') {
                  $writer_deadlinenew = date("d-m-Y", strtotime(@$writer_deadline));
                } else {
                  $writer_deadlinenew = '';
                }
              } else {
