    ...
    <!-- </div> -->
        ...
        <div class="row">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Orders/insert_writer_admin">
                            <div class="form-group">
                                <div class="row col-md-12">
                                    <div class="col-md-8 col-sm-8">
                                        <label class="control-label">Writer Admin Name</label>
                                        <input type="text" placeholder="Enter admin name" name="name" class="form-control" value="" required autofocus>
                                    </div>
                                </div>
                                <div class="row col-md-12">
                                    <div class="col-md-8 col-sm-8">
                                        <label class="control-label">Writer Admin Email</label>
                                        <input type="email" placeholder="Enter admin email" name="email" class="form-control" value="" required autofocus>
                                    </div>
                                </div>
