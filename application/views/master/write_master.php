    ...
    <!-- </div> -->
        ...
        <div class="row">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/Orders/insert_writer">
                            <div class="form-group">
                                ...
                                <div class="row col-md-12">
                                    <div class="col-md-8 col-sm-8">
                                        ...
                                        <input type="text" placeholder="Enter Mobile Number" name="mobile_number" class="form-control" value="" required>
                                    </div>
                                </div>
