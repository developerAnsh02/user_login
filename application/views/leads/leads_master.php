                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example23" class="table table-striped">
                                ...
                                <tbody>
                                    <form class="floating-labels m-t-40" role="form" method="post" action="<?php echo base_url(); ?>index.php/Leads/add_new_lead" enctype="multipart/form-data">
                                        <tr>
                                            <td>
                                                #
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="user_name" name="user_name" style="width: 150px;" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="user_email" name="user_email" style="width: 150px;" />
                                            </td>
                                            <td>
                                                <?php echo form_dropdown('countrycode', $countries, '', 'id="countrycode_select2" style="width:150px"') ?>
                                            </td>
                                            <td>
                                            <select class="form-control typeofservice" name="service_type" style="width:150px">
                                                <option value=""></option>
                                                <?php
                                            ...
                                            <td>
                                                <input name="user_mobile" class="form-control user_mobile" id="mobile" type="number" required onkeyup="check(); return false;" style="width: 150px;">
                                                <span id="message"></span>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="project_title" style="width: 150px;" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control pages" name="pages" style="width: 150px;">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="price" style="width: 150px;" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control second delivery_date mdate" name="delivery_date" value="" style="width:120px">
                                            </td>
                                            <td>
                                                <input class="form-control timepicker" name="delivery_time" style="width: 100px;">
                                            </td>
                                            <td>
                                                <button type="submit" class="btn btn-xs btn-primary btn-block btn-sm m-1">Save</button>
                                            </td>
                                        </tr>
                                    </form>
                                </tbody>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <form class="floating-labels m-t-40" id="c_form" role="form" method="post" action="<?php echo base_url(); ?>index.php/Leads/convert_lead" enctype="multipart/form-data">
                                            <tr <?php if ($lead['status'] == 1) {
                                                    echo "style='background-color: #000000; --bs-table-hover-bg: black; color: white'";
                                                } ?>>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div style="margin-right: 2px;">
                                                            <a class="btn btn-xs btn-danger update btn-sm m-1" title="Update lead">U</a>
                                                        </div>
                                                        <div style="margin-right: 2px;">
                                                            <button onclick="myFunction()" type="submit" id="c_submit" class="btn btn-xs btn-success btn-sm m-1" title="Convert lead to order">S</button>
                                                        </div>
                                                        <div style="margin-right: 2px;">
                                                ...
                                                <td>
                                                    <input type="text" name="service_type" value="<?php echo $lead['service_type']; ?>" class="inputField project_title form-control service_type">
                                                </td>
                                                <td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.update', function() {
                ...
                var service_type = $(this).closest("tr").find('.service_type').val();
